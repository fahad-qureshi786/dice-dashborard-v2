...
const ProductTable = () => {
    ...
    const tableData = [
...

        {
            ...
            location: 'Active',
            cuisine: '50',
            vendorDetail: <div>  <div>
                <Dropdown
                    value={selectedVendor ? tableData.indexOf(selectedVendor) : null}
                    options={vendorOptions}
                    onChange={handleVendorChange}
                    placeholder="Vendor Detail"
                ...
                {selectedVendor && (
                    <div className="mt-4">
                        ...
                        <p><strong>Cuisine:</strong> {selectedVendor.cuisine}</p>
                        <p><strong>Vendor Details:</strong> {selectedVendor.vendorDetails}</p>
                        <p><strong>POC Name:</strong> {selectedVendor.pocName}</p>
                        <p><strong>POC Number:</strong> {selectedVendor.pocNumber}</p>
                        <p><strong>Restaurant Number:</strong> {selectedVendor.restaurantNumber}</p>
                        <p><strong>Menu:</strong> {selectedVendor.menu}</p>
                        <p><strong>Past Orders:</strong> {selectedVendor.pastOrders}</p>
                        <p><strong>Upcoming Orders:</strong> {selectedVendor.upcomingOrders}</p>
                    </div>
                )}
            </div> </div>,
            drivers:  <div>
